...
-- -----------------------------------------------------
-- Execute this query with the root user
-- Grant all privileges on the pizzeria database to the up1zz3r14 user.
-- -----------------------------------------------------
GRANT ALL PRIVILEGES ON pizzeria.* TO 'up1zz3r14'@'%';
...
-- -----------------------------------------------------
-- Execute those queries with the usual user
-- -----------------------------------------------------
